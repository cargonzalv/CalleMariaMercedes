			...
			$("#contact-form").validate({
				...
				messages: {
					name: {
						...
						minlength: "Tu nombre tiene que ser mayor a 2 caracteres"
					},
					email: {
						required: "Necesitamos tu dirección de email para contactarte",
						email: "Por favor ingresa un email válido. Por ejemplo: name@domain.com"
					},
					subject: {
