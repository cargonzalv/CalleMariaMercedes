    ...
    showModal = function(that){
     ...
     if ($('.carouselGallery-wrapper').length === 0) {
        if(typeof imagepath !== 'undefined') {
            ...
            modalHtml += "<div class='carouselGallery-modal'><span class='carouselGallery-left'><span class='glyphicon glyphicon-circle-arrow-left'></span></span><span class='carouselGallery-right'><span class='glyphicon glyphicon-circle-arrow-right'></span></span>";
